...
if __name__ == "__main__":
    defaults = [
        ...
        "--html", str(ROOT / "nyc-immigrant-enclaves/index.html"),
        "--jsonld", str(ROOT / "nyc-immigrant-enclaves/index.jsonld"),
        "--manifest", str(ROOT / "nyc-immigrant-enclaves/record-counts.json"),
    ]
